      ...
      @auth
              <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div class="ml-2 flex justify-center items-center">
                  <a href="{{ route('chats.index') }}" type="button" class="relative rounded-full bg-gray-100 p-1 text-gray-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  {{-- Boton resultados --}}
                <div class="ml-2 flex justify-center items-center">
                  <a href="{{ route('chats.result') }}" type="button" class="relative rounded-full bg-gray-100 p-1 text-gray-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      <span class="absolute -inset-1.5"></span>
                      <span class="sr-only">Resultados</span>

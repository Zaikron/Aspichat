<x-form-section submit="updateProfileInformation">
    <x-slot name="title">
        <p class="text-purple-900 font-bold">{{ __('Información del perfil') }}</p>
    </x-slot>

    <x-slot name="description">
        <p class="text-purple-700 text-sm">{{ __('Actualiza tu informacion de perfil y tu direccion de correo electronico.') }}</p>
    </x-slot>
